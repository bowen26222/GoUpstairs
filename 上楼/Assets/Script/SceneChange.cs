...
public class SceneChange : MonoBehaviour
{
    ...
    public static SceneChange _instance; // 实例
    public MoveScene currentTransition; // 当前的过场预设
    ...
    public void LoadScene(string SceneName, MoveScene transition = null)
    {
        // 如果现在不能转换场景直接返回
        if (!LoadAble) return;
    ...
    private IEnumerator LoadLevel(string levelName)
    {
        ...
        // 等待动画播放完成
        while (!currentTransition.IsChanged())
            yield return null;
